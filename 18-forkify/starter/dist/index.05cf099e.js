...
const controlServings = function(updateTo) {
    ...
    _model.updateServings(updateTo);
...
const init = function() {
    _bookmarksViewDefault.default.addHandlerBookmarks(controlLoadBookmarked);
    ...
    _addRecipeViewDefault.default.addHandlerUploadWindow(controlAddRecipe);
};
init();

},{"./model":"1pVJj","./view/recipeView":"qcgKQ","./view/searchView":"1ShPd","./view/resultsView":"1KAoX","./view/bookmarksView":"9TVaw","./view/paginationView":"9Ia8B","./view/addRecipeView":"h6x5X","./config":"6V52N","core-js/stable":"95FYz","regenerator-runtime/runtime":"1EBPE","./view/View":"9kPNj","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"1pVJj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
const state = {
    ...
    search: {
        ...
        result: [],
        page: 1,
        resultPerPage: _config.RESULTS_PER_PAGE
    },
    bookmarks: []
};
...
const KEY = 'a65b7915-c463-46d9-9e67-b4287f56e5b2';
...
},{"./config":"6V52N","./model":"1pVJj","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"qcgKQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class RecipeView extends _viewDefault.default {
    ...
    _generateMarkupIngredient(ing) {
        // Changed: <div class="recipe__quantity">${ing.quantity ? new fracty(ing.quantity).toString() : ''}</div>
        return `
                <li class="recipe__ingredient">
                    <svg class="recipe__icon">
                    <use href="${_iconsSvgDefault.default}#icon-check"></use>
                    </svg>
                    <div class="recipe__quantity">${ing.quantity ? _fractyDefault.default(ing.quantity) : ''}</div>
...
},{"./View":"9kPNj","url:../../img/icons.svg":"5jwFy","fracty":"8eFPJ","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"9kPNj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"regenerator-runtime":"1EBPE","url:../../img/icons.svg":"5jwFy","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"1EBPE":[function(require,module,exports) {
/**
...
},{}],"8eFPJ":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"1KAoX":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
},{"./View":"9kPNj","./previewView":"k51Qp","url:../../img/icons.svg":"5jwFy","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"k51Qp":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
},{"./View":"9kPNj","url:../../img/icons.svg":"5jwFy","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"9TVaw":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
class BookmarksView extends _viewDefault.default {
    ...
    _errorMessage = 'No bookmarks yet. Fina a nice recipe and bookmarked it.';
    _message = 'Start by bookmarking a recipe!.';
...
},{"./View":"9kPNj","./previewView":"k51Qp","url:../../img/icons.svg":"5jwFy","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"9Ia8B":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
class paginationView extends _viewDefault.default {
    ...
    _generateMarkupButton(type, currentPage) {
        ...
        <svg class="search__icon">
            <use href="${_iconsSvgDefault.default}#icon-arrow-${type === 'next' ? 'right' : 'left'}"></use>
        </svg>
    ...
    _generateMarkup() {
        ...
        if (curPage === 1 && numPage > 1) return this._generateMarkupButton('next', curPage);
        //Last page
        if (curPage === numPage && numPage > 1) return this._generateMarkupButton('prev', curPage);
        //Other page
        if (curPage < numPage) return `${this._generateMarkupButton('next', curPage)}${this._generateMarkupButton('prev', curPage)}`;
...
},{"./View":"9kPNj","url:../../img/icons.svg":"5jwFy","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"h6x5X":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
class AddRecipeView extends _viewDefault.default {
    ...
    addHandlerUploadWindow(handler) {
        this._parentElement.addEventListener('submit', function(e) {
            e.preventDefault();
            const dataArr = [
                ...new FormData(this)
...
},{"./View":"9kPNj","url:../../img/icons.svg":"5jwFy","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"95FYz":[function(require,module,exports) {
...
},{"../internals/export":"8yfGv","../internals/function-call":"jhLed"}]},["kS06O","lA0Es"], "lA0Es", "parcelRequire7e89")
