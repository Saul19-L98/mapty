...
class App{
    ...
    _getPosition(){
        //NOTE: Class 229: Using the Geolocation.
    ...
    _loadMap(position){
            ...
            console.log(`https://www.google.com/maps/@${latitude},${longitude}m`);
    ...
    _renderWorkout(workout){
        ...
        `;
        // console.log(workout.speed.toFixed(1))
        // console.log(workout.elevation)
